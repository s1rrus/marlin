...
#define STRING_CONFIG_H_AUTHOR "(sirrus, rime32)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "rime32"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 405.12, 397 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 10000, 10000, 50, 20000 } // ...or, set your own edit limits
#endif
...
// #define DEFAULT_EJERK                  5.0  // switched to 10 because of build error
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 63.75, -12, -2.5 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.58
  #define XY_DIAG_BD 141.94
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS          112 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  ...
  // #define NEOPIXEL2_SEPARATE
    ...
    #define NEOPIXEL2_PIXELS           112 // Number of LEDs in the second strip
